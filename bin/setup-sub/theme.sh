...
if [ -n "$THEME" ] && [ "$THEME" != "<<-back" ]; then
  cp $SETUP_PATH/themes/$THEME/alacritty.toml ~/.config/alacritty/theme.toml
  cp $SETUP_PATH/themes/$THEME/zellij.kdl ~/.config/zellij/themes/$THEME.kdl
  sed -i "s/theme \".*\"/theme \"$THEME\"/g" ~/.config/zellij/config.kdl
  cp $SETUP_PATH/themes/$THEME/neovim.lua ~/.config/nvim/lua/plugins/theme.lua

  source $SETUP_PATH/themes/$THEME/gnome.sh
  source $SETUP_PATH/themes/$THEME/tophat.sh
  source $SETUP_PATH/themes/$THEME/vscode.sh
