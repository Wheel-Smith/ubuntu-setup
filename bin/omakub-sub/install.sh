...
if [[ "$CHOICE" == "<< Back"* ]] || [[ -z "$CHOICE" ]]; then
  ...
  INSTALLER_FILE=$(gum file $SETUP_PATH/install)
  ...
  case "$INSTALLER" in
  "dev-language") INSTALLER_FILE="$SETUP_PATH/install/terminal/select-dev-language.sh" ;;
  "dev-database") INSTALLER_FILE="$SETUP_PATH/install/terminal/select-dev-storage.sh" ;;
  "ollama") INSTALLER_FILE="$SETUP_PATH/install/terminal/optional/app-ollama.sh" ;;
  *) INSTALLER_FILE="$SETUP_PATH/install/desktop/optional/app-$INSTALLER.sh" ;;
  esac
